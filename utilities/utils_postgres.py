...
class PostgresConnection:
    ...
    def create_conn(self):
        self.conn = create_engine(
            f"postgresql://{self.user}:{self.password}@localhost:5432/{self.database}"
        )
        return self.conn
...
class PostgresOperation:
    """
    This class is responsible for performing operations
        -if a table exists,
        -deleting a table.
    """
...
class PostgresDestination:
    ...
    This class is responsible for
        -loading data to the PostgreSQL database.
    """
